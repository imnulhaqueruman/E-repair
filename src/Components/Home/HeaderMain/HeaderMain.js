...
const HeaderMain = () => {
    return (
        <main className="container-fluid" >
            <section style={{height:600}} className="row d-flex align-items-center">
                <div className="col-md-4 col-sm-6 py-5 my-5 offset-md-1">
                ...
                <div className="col-md-6 col-sm mx-5 px-5">
